...
export default function App() {
  ...
  return (
    <div className="backdrop-blu-sm flex min-h-screen flex-col items-center bg-main font-sans">
      ...
      <div
        className="backdrop-blur-custom shadow-maindata rounded-25px mx-2 mt-14 flex w-full flex-col items-center justify-center overflow-auto bg-white p-6 sm:w-fit"
        style={{
          opacity: opacity,
